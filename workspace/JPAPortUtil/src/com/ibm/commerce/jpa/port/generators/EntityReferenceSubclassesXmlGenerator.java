...
public class EntityReferenceSubclassesXmlGenerator {
	...
	public void generate(IProgressMonitor progressMonitor) {
		...
		Set<String> entityReferenceSubclasses = iProjectInfo.getEntityReferenceSubclasses();
		...
		sb.append("</ProjectInfo>");
		IFile projectInfoXmlFile = iProject.getFile(".jpaEntityReferenceSubclasses.xml");
