...
public class MemberAttributeValueEntityBaseGenerator {
	public static final String TYPE_NAME = "com.ibm.commerce.user.objimpl.MemberAttributeValueJPAEntityBase";
	...
	public static class GetMemberAttributeTypeMethodGenerator implements MethodGenerator {
		public String getMethodKey() {
			return "getMemberAttributeType";
		}
		
		public void appendMethod(StringBuilder sb, EntityInfo entityInfo) {
			sb.append("\r\n\t/**\r\n");
			sb.append("\t * The type of this member attribute value\r\n");
			sb.append("\t * @return  java.lang.String\r\n");
			sb.append("\t */\r\n");
			sb.append("\t@Transient\r\n");
			sb.append("\tpublic String getMemberAttributeType() {\r\n");
